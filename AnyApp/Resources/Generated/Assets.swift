...
public enum Asset {
  ...
  public enum Images {
    ...
    public static let commonError = ImageAsset(name: "Images/commonError")
    ...
    public static let noInternet = ImageAsset(name: "Images/noInternet")
    ...
    public static let phoneWithCircle = ImageAsset(name: "Images/phoneWithCircle")
